...
<body>
            ...
            <div class=" head">
                ...
                <nav class="navbar">
                    ...
                    <div class="drop-down">
                        ...
                        <a href="{{route('register')}}" class=" register" target="_blank"><i class="fa-solid fa-caret-left"></i>انضم الينا</a>
                ...
                <div class="icons">
                    ...
                    <div class="buttons" id="btns">
                        <a href="{{ route('patiant') }}" target="_blank" >
                            {{ auth()->user()->name }}
                        </a>
                    </div>
                    @else
                    ...
                    <div class="buttons" id="btns">
                        <a href="{{route('login')}}" target="_blank" class="register"> تسجيل دخول </a>
                        <a href="{{route('register')}}" target="_blank" class=" register" >انضم الينا</a>
                    </div>
                    @endif
                </div>
            </div>
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s"
                            src="{{asset('assets/img/Doctors.jpeg')}}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <ul>
                        ...
                        <li class="wow zoomIn" data-wow-delay="0.9s"><a href="#">دكتور قلب وأوعية دموية</a><a
                                href="#">دكتور عيون</a></li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <h4 class="text-body fst-italic mb-4"> إختار المحافظة وإحجز كشف دكتور </h4>
                    <ul>
                        <li class="wow zoomIn" data-wow-delay="1.2s"><a href="#">القاهرة</a><a href="#">الإسكندرية</a><a
                                href="#">الدقهلية</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <form class="d-flex align-items-center  flex-column  bg-sec" action="{{ route('doctor.search') }}" method="POST" id="reseve">
                    @csrf
                    <select class="form-control govern" name="government">
                    ...
                    <select class="form-control" name="specialist" id="specialist">
                        ...
                        <option value="أطفال و حديثى الولادة">أطفال و حديثى الولادة</option>
                        ...
                        <option value="نفسى">نفسى</option>
                    </select>
                    <button class="go" tabindex="4">سجل الان </button>
                    {{-- <a href="database/data.html" class="go">سجل الأن</a> --}}
                </form>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget footer-menu">
                            ...
                            <ul>
                                <li>
                                    <a href="login/reg.html" target="_blank"> انضم الينا كطبيب</a>
                                </li>
                                <li>
                                    <a href="login/reg.html" target="_blank"> انضم الينا كصيدلى</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget footer-contact">
                            ...
                            <div class="footer-widget footer-menu">
                                    <ul>
                                        <li><a href="login/index.html" target="_blank"> تسجيل الدخول </a></li>
                                        <li><a href="login/reg.html" target="_blank"> مستخدم جديد</a></li>
                                    </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{asset('assets/lib/waypoints/waypoints.min.j')}}s"></script>
